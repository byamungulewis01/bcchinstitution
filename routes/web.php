...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/consultancies/{career_id}', 'consultancy')->name('consultancy');
...
Route::group(['middleware' => 'auth', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::middleware('user-access:admin,super_admin')->resource('consultance', ConsultanceController::class);
