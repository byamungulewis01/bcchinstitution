<ul class="menu-inner py-1">
    ...
    <li
        class="menu-item {{ Request::routeIs(['admin.consultance.index', 'admin.careers.index', 'admin.consultance.create', 'admin.consultance.edit']) ? 'open' : '' }} ">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons ti ti-components"></i>
            <div data-i18n="Consultance">Consultancy</div>
        </a>
        <ul class="menu-sub">
            <li class="menu-item {{ Request::routeIs('admin.careers.index') ? 'active' : '' }}">
            ...
            <li
                ...
                <a href="{{ route('admin.consultance.index') }}" class="menu-link">
                    <div data-i18n="Consultancy List">Consultancy List</div>
                </a>
            </li>
    ...
    <li
        class="menu-item {{ Request::routeIs(['admin.accreditation.index', 'admin.accreditation.create', 'admin.accreditation.edit']) ? 'active' : '' }}">
    ...
    <li
        class="menu-item {{ Request::routeIs([
            'admin.pages.about',
            'admin.pages.contact',
            'admin.pages.home_banners',
            'admin.pages.structure',
            'admin.pages.create_structure',
            'admin.pages.edit_structure',
            'admin.front-pages.partners.index',
            'admin.front-pages.leadership.index',
            'admin.front-pages.awards.index',
            'admin.front-pages.policy.index',
            'admin.front-pages.testimony.index',
        ])
            ? 'open'
            : '' }} ">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <ul class="menu-sub">
            ...
            <li
                class="menu-item {{ Request::routeIs(['admin.pages.structure', 'admin.pages.create_structure', 'admin.pages.edit_structure']) ? 'active' : '' }}">
                <a href="{{ route('admin.pages.structure') }}" class="menu-link">
                    <div data-i18n="Organization Structure">Organization Structure</div>
                </a>
            </li>
            <li class="menu-item {{ Request::routeIs('admin.front-pages.partners.index') ? 'active' : '' }}">
                <a href="{{ route('admin.front-pages.partners.index') }}" class="menu-link">
                    <div data-i18n="Partners">Partners</div>
                </a>
            </li>
            <li class="menu-item {{ Request::routeIs('admin.front-pages.leadership.index') ? 'active' : '' }}">
                <a href="{{ route('admin.front-pages.leadership.index') }}" class="menu-link">
                    <div data-i18n="Leadership">Leadership</div>
                </a>
            </li>
            <li class="menu-item {{ Request::routeIs('admin.front-pages.awards.index') ? 'active' : '' }}">
                <a href="{{ route('admin.front-pages.awards.index') }}" class="menu-link">
                    <div data-i18n="Awards">Awards</div>
                </a>
            </li>
            <li class="menu-item {{ Request::routeIs('admin.front-pages.policy.index') ? 'active' : '' }}">
                <a href="{{ route('admin.front-pages.policy.index') }}" class="menu-link">
                    <div data-i18n="Policies">Policies</div>
                </a>
            </li>
            <li class="menu-item {{ Request::routeIs('admin.front-pages.testimony.index') ? 'active' : '' }}">
                <a href="{{ route('admin.front-pages.testimony.index') }}" class="menu-link">
                    <div data-i18n="Testimonies">Testimonies</div>
                </a>
            </li>
            <!-- <li class="menu-item {{ Request::routeIs('admin.student.rejected') ? 'active' : '' }}">
            <a href="{{ route('admin.student.rejected') }}" class="menu-link">
