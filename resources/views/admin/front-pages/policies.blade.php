                    ...
                    <div class="modal-dialog modal-md modal-dialog-centered1 modal-simple modal-add-new-cc">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form method="POST" class="row g-2" action="{{ route('admin.front-pages.policy.store') }}">
                                    @csrf
                                    <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="deleteForm_{{ $item->id }}"
                                        action="{{ route('admin.front-pages.policy.destroy', $item->id) }}" method="post"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <a href="javascript:;"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" class="row g-2"
                                                action="{{ route('admin.front-pages.policy.update', $item->id) }}">
                                                @csrf
                                                @method('PUT')
                                                <div class="col-12">
                                                    <label for="title" class="form-label">Title</label>
