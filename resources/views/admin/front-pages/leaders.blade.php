                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form method="POST" class="row g-2"
                                    action="{{ route('admin.front-pages.leadership.store') }}"
                    ...
                    @foreach ($collection as $item)
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="card h-100">
                                <img class="card-img-top" src="{{ asset('images/leaders/' . $item->image) }}"
                                    alt="Card image cap">
                                <div class="card-body">
                                    ...
                                    <form id="deleteForm_{{ $item->id }}"
                                        action="{{ route('admin.front-pages.leadership.destroy', $item->id) }}"
                                ...
                                <div class="modal-dialog modal-md modal-dialog-centered1 modal-simple modal-add-new-cc">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" class="row g-2"
                                                action="{{ route('admin.front-pages.leadership.update', $item->id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <label for="position" class="form-label">Position</label>
                                                    <input name="position" type="text" class="form-control" required
                                                        placeholder="Position" value="{{ old('position', $item->position) }}">
                                                </div>
                                                <div class="col-md-12">
                                                    <label>Image</label>
                                                    <input name="file" type="file" class="form-control">
